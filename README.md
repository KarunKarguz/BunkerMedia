...
- `GET /videos?limit=100&search=keyword&channel=name&downloaded_only=true&freshness_days=30&duration_min=300&duration_max=5400`
- `GET /videos/{video_id}`
...
- `DELETE /deadletters?retried_only=true`
